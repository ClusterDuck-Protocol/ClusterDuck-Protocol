...
<<<<<<< HEAD:cdp-dependency-automator-script/install-dependencies.py
=======
    ...
    while retry_count < 5:
        try:
            ...
            if retry_count == MAX_RETRIES:
                print(f"Failed to download {dependency}.")
                retry_count = 0
>>>>>>> task/341_CDP_refactor_and_build_fixes:tools/cdp-dependency-automator-script/install-dependencies.py
                break
