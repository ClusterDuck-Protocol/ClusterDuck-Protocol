...
<html>
    ...
    <body>
        ...
        <div class="logo-container">
            ...
            <h2 class="">Project OWL</h2>
        </div>

        <div class="content body" id="formContent">
            <h3>You are now connected to a D.U.C.K. network.</h3>

            <div id="form">
                <form action="/formSubmit" method="post">
                    <label for="firstName">Your Name</label><br>
                    <input class="textbox textbox-full" name="firstName" id="firstName" type="text" placeholder="John Smith" /><br><br>
...
<!--                     <br /> <br /> -->
                    <label for="status">Status (max 140 characters)</label><br /> 
                    <textarea class="textbox comments" name="message" id="commentsInput" maxlength="140"></textarea><br /> 

                    <input type="submit" class="sendReportBtn" value="SEND" />
                </form>
<!-- 
